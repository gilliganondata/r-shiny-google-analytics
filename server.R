...
segMaster <- rbind(segMaster,c("Device Category","Desktop","condition::ga:deviceCategory==desktop"))
segMaster <- rbind(segMaster,c("Device Category","Tablet","condition::ga:deviceCategory==tablet"))
segMaster <- rbind(segMaster,c("Device Category","Mobile","condition::ga:deviceCategory==mobile"))
segMaster <- rbind(segMaster,c("New vs. Returning","New Visitors","condition::ga:userType==New Visitor"))
segMaster <- rbind(segMaster,c("New vs. Returning","Returning Visitors","condition::ga:userType==Returning Visitor"))
